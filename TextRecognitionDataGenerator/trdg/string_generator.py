...
def create_strings_from_file(filename: str, count: int) -> List[str]:
    print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!string_generator.py create_strings_from_file filename : {filename}')
    print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!string_generator.py create_strings_from_file count : {count}')
    ...
    with open(filename, "r", encoding="utf8") as f:
        ...
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!string_generator.py create_strings_from_file lines : {lines}')
        #print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!string_generator.py create_strings_from_file len(strings) : {len(strings)}')
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!string_generator.py create_strings_from_file count : {count}')
        ...
        while len(strings) < int(count):

            #if len(lines) >= count - len(strings):
            if len(lines) >= int(count) - len(strings):
                #strings.extend(lines[0 : count - len(strings)])
                strings.extend(lines[0: int(count) - len(strings)])
            else:
                strings.extend(lines)

    #print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!string_generator.py create_strings_from_file strings : {strings}')
