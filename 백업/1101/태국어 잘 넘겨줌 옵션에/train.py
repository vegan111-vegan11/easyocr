...
def train(opt):
    ...
    print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!train opt.character : {opt.character}')
    ...
    print(f'##########################!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!train  인코딩 잘됨???? opt.character : {opt.character}')
    ...
    while (True):
        ...
        print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!labels 도대체 어디서 소문자로 바뀌???????: {labels}')
...
if __name__ == '__main__':
    ...
    opt_character = ' ()+-./01234569ACDFGILQSTWabeghimnoprstuz~°กขคงจฉชซฑณดตถทธนบปผฝพฟภมยรลวศษสหฬอะัาำิีึืุูเแโใไ็็่้๊์✓'.encode(
        'utf-8').decode('utf-8')
    print(f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!parser.add_argument 함수에 들어가기 전 opt_character : {opt_character}')
    ...
    if opt.sensitive:
        ...
        print(
            f'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!센서티브에서 지맘대로 아스키로 바꾼후!!!!!!(use 94 char) 어쩌고 저쩌고   !!!!!!!!!! string.printable : {string.printable}')
