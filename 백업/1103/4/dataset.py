    ...
    def get_batch(self):
        ...
        for i, data_loader_iter in enumerate(self.dataloader_iter_list):
            ...
            try:
                ...
                print(f'get_batch  next(data_loader_iter) balanced_batch_texts : {balanced_batch_texts}')
...
def hierarchical_dataset(root, opt, select_data=''):
    ...
    print(dataset_log)
    print(f'hierarchical_dataset 진짜 ㅜㅜㅜㅜㅜㅜㅜ   hierarchical_dataset root : {root}')
